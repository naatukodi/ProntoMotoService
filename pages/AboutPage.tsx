    ...
    <div className="bg-gray-50 animate-pageFadeIn">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold animate-fadeInDown tracking-tight">About Pronto Moto Services</h1>
          <p className="mt-4 text-lg text-gray-300 animate-fadeInUp max-w-3xl mx-auto" style={{animationDelay: '0.3s'}}>Precision, Integrity, and Experience in Every Valuation</p>
        </div>
      </header>
                  ...
                  <div ref={scanlineRef} className="relative group p-4 sm:p-8">
                      ...
                      <div className={`relative scanline-reveal-container ${isScanlineVisible ? 'revealed' : ''} rounded-xl shadow-2xl border-4 border-white`}>
                          <img 
                              ...
                              alt="Pronto Moto Services leadership team in a professional group photo"
              ...
              <ScrollAnimator animation="animate-slideInRight" delay={200}>
                  <div>
                      ...
                      <p className="text-gray-600 leading-relaxed mb-4">
                          With a combined experience of over 60 years, Pronto Moto Services is a tech-enabled vehicle inspection and valuation firm trusted by banks, NBFCs, and insurance providers.
                      </p>
