    ...
    >
      <div className="w-12 h-12 flex-shrink-0">
        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="logoTitle">
          <title id="logoTitle">Vehga Inspections Private Limited Icon</title>
          ...
          <g className="transition-transform duration-500 ease-in-out origin-bottom transform-gpu group-hover:rotate-[-4deg]">
            ...
            <g 
              ...
              className={`transition-all duration-500 ease-in-out transform-gpu transform-origin-center group-hover:scale-[1.4] ${
                isLoader 
                  ? 'animate-loader-car-spin-and-lift animate-loader-car-glow' 
                  : 'animate-car-intro-lift animate-car-intro-glow'
              } group-hover:drop-shadow-[0_4px_8px_rgba(249,115,22,0.6)]`}
            >
              <ellipse 
                cx="50" 
                cy="60" 
                ...
                fill="#2D3748" 
                opacity="0.25" 
                className="transition-all duration-300 ease-out group-hover:rx-16 group-hover:opacity-15"
              />
              ...
              <g>
                ...
                />
                <path 
                  d="M43,51 C42,48, 45,46, 48,46 H54 C57,46, 58,48, 57,51 Z" 
                  fill="#D95B00" 
                  className="transition-colors duration-300 group-hover:fill-orange-500" 
                />
      ...
      {showText && (
        <div className={`${textColorClass} hidden sm:block`}>
          <div className="font-extrabold text-base leading-tight tracking-tight">
            ...
            <span className="text-accent-orange">PVT LTD</span>
          </div>
        </div>
      )}
    </Link>
