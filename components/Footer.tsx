...
const Footer: React.FC = () => {
  ...
  const mailtoSubject = encodeURIComponent("Inquiry via Vehga Inspections Private Limited Website");
  const mailtoBody = encodeURIComponent("Hello Vehga Inspections Private Limited team,\n\nI'm reaching out to inquire about...\n\nBest regards,");
