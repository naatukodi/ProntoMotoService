  ...
  useEffect(() => {
    ...
    const svgString = `
      <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Lens */}
        <circle cx="50" cy="42" r="18" fill="#F8F9FA" stroke="#E2E8F0" strokeWidth="1" />
        ...
        <g transform="translate(0, -8)">
          ...
          {/* Car Body */}
          <g>
            <path d="M38,56 V52 C40,50.5, 50,50.5, 52,51 L60,51 C62,51, 63,52, 63,54 V56 Z" fill="#249094" />
            <path d="M43,51 C42,48, 45,46, 48,46 H54 C57,46, 58,48, 57,51 Z" fill="#249094" />
