...
const WhyChooseUs: React.FC = () => {
  return (
    <section className="relative py-20 overflow-hidden text-gray-800">
      {/* Animated Gradient and Grid Background */}
      <div className="absolute inset-0 z-0">
         <div 
           className="absolute inset-0 bg-gradient-to-br from-white via-gray-50 to-gray-100 animate-animated-gradient"
         ...
         <div 
           ...
           style={{
             backgroundImage: `
               linear-gradient(rgba(36, 144, 148, 0.05) 1px, transparent 1px),
               linear-gradient(to right, rgba(36, 144, 148, 0.05) 1px, transparent 1px)
             `,
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
            ...
            >
                ...
                >
                <div className="flex-shrink-0 w-10 h-10 text-accent-orange mr-4 transition-all duration-300 group-hover:scale-110 group-hover:rotate-[-12deg]">
                    {point.icon}
                </div>
                <div>
